 ...
 * only once.
 * 
 * For example, array A such that: A[0] = 4 A[1] = 1 A[2] = 3 A[3] = 2 is a
 * permutation, but array A such that: A[0] = 4 A[1] = 1 A[2] = 3 is not a
 * permutation, because value 2 is missing.
 * 
 ...
 * 0 if it is not.
 * 
 * For example, given array A such that: A[0] = 4 A[1] = 1 A[2] = 3 A[3] = 2 the
 * function should return 1.
 * 
 * Given array A such that: A[0] = 4 A[1] = 1 A[2] = 3 the function should
 * return 0.
 * 
 * Assume that:
 * 
