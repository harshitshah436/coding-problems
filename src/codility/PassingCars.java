 ...
 * leq P < Q < N, is passing when P is traveling to the east and Q is traveling
 * to the west.
 * 
 * For example, consider array A such that: A[0] = 0 A[1] = 1 A[2] = 0 A[3] = 1
 * A[4] = 1 We have five pairs of passing cars: (0, 1), (0, 3), (0, 4), (2, 3),
 * (2, 4).
 * 
 * Write a function:
 * 
 ...
 * 1,000,000,000.
 * 
 * For example, given: A[0] = 0 A[1] = 1 A[2] = 0 A[3] = 1 A[4] = 1 the function
 * should return 5, as explained above.
 * 
 * Assume that:
 * 
 * -N is an integer within the range [1..100,000]; -each element of array A is
 * an integer that can have one of the following values: 0, 1.
 * 
 * Complexity:
 * 
