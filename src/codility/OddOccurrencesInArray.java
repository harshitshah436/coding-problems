...
public class OddOccurrencesInArray {
    // Simple solution. Don't think to make an array and count number of
    // occurances for each value.
    // Rather very simple solution, XORing with all elements would be results in
    // unpaired element.
