 ...
 * covering prefix of array A is the smallest integer P such that 0 leq P
 * lessthan N and such that every value that occurs in array A also occurs in
 ...
 * 
 * A[0] = 2 A[1] = 2 A[2] = 1 A[3] = 0 A[4] = 1 the function should return 3, as
 * explained above.
 * 
 * Assume that:
 * 
 * N is an integer within the range [1..1,000,000]; each element of array A is
 * an integer within the range [0..N-1]. Complexity:
 * 
